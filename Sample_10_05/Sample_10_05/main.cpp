...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    SpriteInitData luminanceSpriteInitDate;

    luminanceSpriteInitDate.m_fxFilePath = "Assets/shader/samplePostEffect.fx";

    luminanceSpriteInitDate.m_vsEntryPointFunc = "VSMain";

    luminanceSpriteInitDate.m_psEntryPoinFunc = "PSSamplingLuminance";

    luminanceSpriteInitDate.m_width = FRAME_BUFFER_W;
    luminanceSpriteInitDate.m_height = FRAME_BUFFER_H;

    luminanceSpriteInitDate.m_textures[0] = &mainRenderTarget.GetRenderTargetTexture();

    luminanceSpriteInitDate.m_colorBufferFormat[0] = DXGI_FORMAT_R32G32B32A32_FLOAT;

    Sprite luminanceSprite;
    luminanceSprite.Init(luminanceSpriteInitDate);
